...
<html lang="{{ app()->getLocale() }}">
    ...
    <nav class="navbar navbar-custom navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand logo" href="#">UBOLD</a>
            ...
            <div class="collapse navbar-collapse" id="navbarsMenu">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="" class="btn btn-custom navbar-btn">Try for Free</a>
                    </li>
                </ul>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="features-box">
                        ...
                        <h6 class="m-t-20">Responsive Layouts</h6>
                ...
                <div class="col-sm-4">
                    <div class="features-box">
                        ...
                        <h6 class="m-t-20">Bootstrap UI based</h6>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 ml-auto">
                    <img src="images/mac_1.png" alt="img" class="img-fluid m-t-20">
                </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <img src="images/mac_2.png" alt="img" class="img-fluid">
                </div>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="text-muted copyright">© 2016 - 2017. All rights reserved.</p>
                </div>
