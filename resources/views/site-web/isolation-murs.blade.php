    ...
    <section>
        <div class="container">
            <div class="d-flex flex-row justify-content-between mt-50 mb-50">
                <div class="part1">
                    <img src="{{ asset('images/technique-isolation-mur.jpg') }}" class="img-hero" alt="Illustration isolation des combles perdus">
                </div>
                <div class="part2 text-center">
                    <h1 class="mb-20 mt-30 text-white">L'isolation des murs</h1>
                    <div class="">
                        <div>
    ...
    <section>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-10">
                    <h2 class="text-center mb-30">Vous avez un garage ou un atelier mitoyen à votre habitation :</h2>
