                        ...
                        <div class="card-box">
                            <div class="contact-card">
                                <div class="member-info">
                                    ...
                                    <h5 class="">Pose prévu le : {{ $pose->rdv_jour_pose}} à {{ $pose->rdv_heure_pose}}</h5>
                                ...
                                <div class="collapse" id="collapse-{{ $pose->id }}">
                                    <div class="card card-body">
                                        <form id="formLeadWeb{{ $pose->id }}" method="get" action="{{ route('crm.chantier-valide-accepter', ['id' => $pose->id]) }}">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control datepicker" placeholder="jour/mois/année" name="rdv_jour_pose">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div>
                                                        <div class="input-group clockpicker" data-placement="top" data-align="top" data-autoclose="true">
                                                            <input type="text" class="form-control" value="13:14" name="rdv_heure_pose">
                                            ...
                                            <div class="row justify-content-center">
                                                <button type="submit" class="btn btn-success waves-effect waves-light">Valider la pose</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
