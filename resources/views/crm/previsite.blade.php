                            ...
                            <div class="contact-card">
                                <div class="member-info">
                                    <div class="departement">
                                        <a class="text-dark" href="{{ route('crm.previsite', ['departement' => $pose->departement]) }}"> {{ $pose->departement }}</a>
                                    </div>
                                    <h5 class="">Pré-visite le : {{ $pose->rdv_jour_previsite}} à {{ $pose->rdv_heure_previsite}}</h5>
                                ...
                                <div class="collapse" id="collapse-{{ $pose->id }}">
                                    <div class="card card-body">
                                        <form id="formPrevisite{{ $pose->id }}" method="get" action="{{ route('crm.previsite-accepter', ['id' => $pose->id]) }}">
                                            ...
                                            <div class="row justify-content-center">
                                                <button type="submit" class="btn btn-success waves-effect waves-light">Valider la prévisite</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
