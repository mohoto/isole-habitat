                        ...
                        <div class="card-box">
                            <div class="contact-card">
                                <div class="member-info">
                                    ...
                                    <h5 class="">Pré-visite faite le : {{ $pose->rdv_jour}} à {{ $pose->rdv_heure}}</h5>
                                ...
                                <div class="collapse" id="collapse-{{ $pose->id }}">
                                    <div class="card card-body">
                                        <form id="formLeadWeb{{ $pose->id }}"  method="get" action="{{ route('crm.previsite-valide-accepter', ['id' => $pose->id]) }}">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control datepicker" placeholder="jour/mois/année" name="rdv_jour_chantier">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div>
                                                        <div class="input-group clockpicker" data-placement="top" data-align="top" data-autoclose="true">
                                                            <input type="text" class="form-control" value="13:14" name="rdv_heure_chantier">
