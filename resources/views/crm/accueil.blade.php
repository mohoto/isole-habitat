                        ...
                        <div class="bar-widget">
                            <div class="table-box">
                                ...
                                <div class="table-detail">
                                    ...
                                    <h5 class="text-muted m-b-0 m-t-0 font-16">Visiters</h5>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-xl-4">
                    <div class="card-box">
                        ...
                        <div class="mx-box">
                            <ul class="list-unstyled transaction-list m-r-5 slimscroller">
                                <li>
                ...
                <div class="col-lg-12 col-xl-4">
                    <div class="card-box">
                        ...
                        <div class="chat-conversation">
                            <ul class="conversation-list slimscroller" style="height: 200px;">
                                <li class="clearfix">
                ...
                <div class="col-lg-12 col-xl-4">
                    <div class="card-box">
                        ...
                        <div class="todoapp">
                            ...
                            <div>
                                <ul class="list-group no-margn slimscroller todo-list" id="todo-list"></ul>
                            </div>
