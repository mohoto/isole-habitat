...
class CreateAppelTelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('appel_tels', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('revenu_fiscal')->nullable();
    ...
    {
        Schema::dropIfExists('appel_tels');
    }
}
